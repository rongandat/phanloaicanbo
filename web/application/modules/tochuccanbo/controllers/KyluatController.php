...
class Tochuccanbo_KyluatController extends Zend_Controller_Action {
    ...
    public function init() {
        ...
        //kiem tra permission
        $check_permission = $this->_helper->global->checkPermission($identity->group_id, '4013');
        if (!$check_permission) {
    ...
    public function indexAction() {
        ...
        $this->view->title = 'Quản lý kỷ luật/khiển trách - ' . $translate->_('TEXT_DEFAULT_TITLE');
        ...
        $list_ky_luat = $kyluatModel->fetchAllByDate("$nam-$thang-01 00:00:00", "$nam-$thang-31 23:59:59");
    ...
    function jqkyluatAction() {
        ...
        if ($this->_request->isPost()) {
            ...
            if ($success_message) {
                ...
                $data['tb_tieu_de'] = '[Ky luật/Khiển trách] ' . $kl_ly_do;
