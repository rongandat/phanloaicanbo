...
class Danhsach_HochamController extends Zend_Controller_Action {
    ...
    public function init() {
        ...
        //kiem tra permission
        $check_permission = $this->_helper->global->checkPermission($identity->group_id, '5004');
        if (!$check_permission) {
    ...
    public function xuatAction() {
        ...
        if (sizeof($list_items)) {
            ...
            header('Content-Disposition: attachment;filename="Bang_Thong_Tin_Nhan_Vien_Theo_Hoc_Ham.xls"');
