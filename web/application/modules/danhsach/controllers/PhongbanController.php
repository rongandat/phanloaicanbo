...
class workSheet {
    ...
    function setWorkSheet($param) {
        $this->work_sheet = $param;
    }
...
class Danhsach_PhongbanController extends Zend_Controller_Action {
    ...
    public function xuatAction() {
        ...
        if (sizeof($list_items)) {
            ...
            header('Content-Disposition: attachment;filename="Bang_Thong_Tin_Nhan_Vien_Theo_Phong.xls"');
