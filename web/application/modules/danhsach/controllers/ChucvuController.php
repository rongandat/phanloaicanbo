...
class Danhsach_ChucvuController extends Zend_Controller_Action {
    ...
    public function init() {
        ...
        //kiem tra permission
        $check_permission = $this->_helper->global->checkPermission($identity->group_id, '5002');
        if (!$check_permission) {
    ...
    public function xuatAction() {
        ...
        $filters = array();
        if($filter_selected) $filters['em_chuc_vu'] = $filter_selected;
        ...
        if (sizeof($list_items)) {
            ...
            header('Content-Disposition: attachment;filename="Bang_Thong_Tin_Nhan_Vien_Theo_Chuc_Vu.xls"');
