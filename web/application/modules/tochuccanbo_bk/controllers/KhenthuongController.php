...
class Tochuccanbo_KhenthuongController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->view->title = 'Quản lý khen thưởng - ' . $translate->_('TEXT_DEFAULT_TITLE');
        ...
        $list_khen_thuong = $khenthuongModel->fetchAllByDate("$nam-$thang-01 00:00:00", "$nam-$thang-31 23:59:59");
