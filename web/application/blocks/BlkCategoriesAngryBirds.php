<?php
class Block_BlkCategoriesAngryBirds extends Zend_View_Helper_Abstract{
	
	function blkCategoriesAngryBirds()
	{
		$view  = $this->view;
		...
		//print_r($listMenu);
		require_once (BLOCK_PATH . '/BlkCategoriesAngryBirds/default.php');
	}
}