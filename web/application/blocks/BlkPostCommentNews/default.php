<div style="width: 100%; height: 100px; margin-top: 10px;">
	...
	<div id='comment_content' style="width: 540px; height: 50px; float: left; margin-left: 15px;">
		...
		<div id="post_status" style="width: 540px; height: 20px; float: right; margin-top: 10px;">
			...
			<div id="post_button" style="width: 50%; float: right; text-align: right;"><button id="btnCancel" type="button" onclick="cancelClick(<?php echo MAX_COMMENT_LENGTH;?>);" <?php echo $disable;?>>Cancel</button><button id="btnPost" type="button" onclick="postClickNews(<?php echo $id.','.MAX_COMMENT_LENGTH;?>);" <?php echo $disable;?>>Post</button></div>
		</div>
	</div>
</div>
