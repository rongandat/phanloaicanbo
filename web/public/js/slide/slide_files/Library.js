...
function CheckValue(o){
	if(Trim(o.value)=='Tìm kiếm'||Trim(o.value)==''){
		o.value = '';
		o.focus();
		return false;
	}
...
function writeSociable(vLink, vTitle, vDescription, vId, SubjectID) {
	...
	var strOut = "";
	strOut += "<div class=\"fr sharend\">"
	strOut += "<div class=\"fl borl\"></div>"
	strOut += "<ul class=\"fl mid\">"
	//strOut += "<li><a class="bb" href="#" title="Banbe"></a></li>
	strOut += "<li><a class=\"fb\" title=\"Facebook\" onfocus=\"this.blur();\" href=\"http://vnexpress.net/Service/Share/?sjid=" + SubjectID + "&sid=1&myurl=" + Url.encode("http://www.facebook.com/share.php%3fu=" + vLink + "%26t=" + vTitle + "") + "'\" target=\"_blank\" id=\"facebook\" rel=\"nofollow\"></a></li>"
	strOut += "<li><a class=\"tw\" onfocus=\"this.blur();\" title=\"Twitter\" href=\"http://vnexpress.net/Service/Share/?sjid=" + SubjectID + "&sid=3&myurl=" + Url.encode("http://twitter.com/home%3fstatus=" + vTitle + " - " + vLink + "") + "'\" target=\"_blank\" id=\"twitter\" rel=\"nofollow\"></a></li>"
	//strOut += "<li><a class="gg" href="#" title="Google+"></a></li>
	strOut += "<li><a class=\"em\" onclick=\"return EmailSubject("+ SubjectID +")\" title=\"Email\"></a></li>"
	strOut += "<li><a class=\"pr\" onclick=\"return PrintSubject()\" title=\"Print\"></a></li>"
	strOut += "</ul>"
	strOut +="<div class=\"fl borr\"></div>"
	strOut +="</div>"
				...
				if (req.responseXML.getElementsByTagName('I')[i].getElementsByTagName('I').length > 0){
					with (req.responseXML.getElementsByTagName('I').item(i)){
						...
						if(getNodeValue(getElementsByTagName('SI')).length > 0){							
							...
							vVideo = vVideo.concat('<a class="fl" href="' + getNodeValue(getElementsByTagName('P')) + '/">');
							vVideo = vVideo.concat('	<img alt="" src="' + imgP + '/' +  getNodeValue(getElementsByTagName('SI')) + '" />');
							vVideo = vVideo.concat('</a>');						
						}
						vVideo = vVideo.concat('<p class="title">');
						vVideo = vVideo.concat('	<a href="' + getNodeValue(getElementsByTagName('P')) + '/">');
